...
class Case10(Case):
    def __init__(self):
        ...
        self.l = None # length of square flow passage
        self.a = None # inner side dimension of square cross section
        self.b = None # outer side dimension of square cross section
    ...
    def param_menu(self):
        print(f"===== PARAMETERS =====" +
            f"\n   1. L  - length of square flow passage" + 
            f"\n   2. a  - inner side dimension of square cross section" + 
            f"\n   3. b  - outer side dimension of square cross section" + 
    ...
    def cond_menu(self):
        print("===== CONDITIONS =====" + 
            ...
            f"\n   2. T1 - temperature of inner surface" + 
            f"\n   3. T2 - temperature of outer surface\n")
    ...
    def reset_cond(self):
        self.q = None # heat transfer rate
        self.t1 = None # temperature of inner surface
        self.t2 = None # temperature of outer surface
    
    def shape_factor(self):
        if all([self.l, self.a, self.b]):
            if self.a/self.b > 1.4:
                self.s = (2*math.pi*self.l)/(0.93*math.log(0.948*self.a/self.b))
            else:
                self.s = (2*math.pi*self.l)/(0.785*math.log(self.a/self.b))
            return self.s
        else:
