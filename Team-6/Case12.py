...
class Case12(Case):
    def __init__(self):
        ...
        self.d = None # diameter of disk
        self.z = None # distance bellow surface
    ...
    def display(self):
        print(f"\n(12) Disk buried parallel to the surface" + 
    ...
    def param_menu(self):
        print(f"===== PARAMETERS =====" +
            f"\n   1. D  - diameter of disk" + 
            f"\n   2. z  - distance below surface" + 
    ...
    def cond_menu(self):
        print("===== CONDITIONS =====" + 
            ...
            f"\n   2. T1 - temperature of disk surface" + 
