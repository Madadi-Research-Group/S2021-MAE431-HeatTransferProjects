...
class Case14(Case):
    def __init__(self):
        ...
        self.l = None # thickness of walls
    ...
    def cond_menu(self):
        print("===== CONDITIONS =====" + 
            ...
            f"\n   2. T1 - temperature of inside corner" + 
            f"\n   3. T2 - temperature of outside corner\n")
    ...
    def reset_cond(self):
        self.q = None # heat transfer rate
        self.t1 = None # temperature of inside corner
        self.t2 = None # temperature of outside corner
